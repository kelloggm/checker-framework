...
public final class String
     ...
     */
    public String(char value[], @NonNegative int offset, @NonNegative int count) {
        if (offset < 0) {
     ...
     * @since  JDK1.1
     */
    public String(byte bytes[], @NonNegative int offset, @NonNegative int length, String charsetName)
            throws UnsupportedEncodingException {
        if (charsetName == null)
     ...
     * @since  1.6
     */
    public String(byte bytes[], @NonNegative int offset, @NonNegative int length, Charset charset) {
        if (charset == null)
     ...
     * @since  JDK1.1
     */
    public String(byte bytes[], @NonNegative int offset, @NonNegative int length) {
        checkBounds(bytes, offset, length);
    ...
    */
     ...
     */
    void getChars(char dst[], @NonNegative int dstBegin) {
     ...
     */
    public void getChars(@NonNegative int srcBegin, @NonNegative int srcEnd, char dst[], @NonNegative int dstBegin) {
        if (srcBegin < 0) {
     ...
     */
    public @GTENegativeOne int indexOf(int ch, int fromIndex) {
     ...
     */
    public @GTENegativeOne int lastIndexOf(int ch, int fromIndex) {
        if (ch < Character.MIN_SUPPLEMENTARY_CODE_POINT) {
            // handle most cases here (ch is a BMP code point or a
            // negative value (invalid code point))
            final char[] value = this.value;
     ...
     */
    public String substring(@NonNegative int beginIndex) {
        if (beginIndex < 0) {
     ...
     *             <code>endIndex</code>.
     */
    public String substring(@NonNegative int beginIndex, @NonNegative int endIndex) {
        if (beginIndex < 0) {
            throw new StringIndexOutOfBoundsException(beginIndex);
        }
     ...
     * @spec JSR-51
     */
    public CharSequence subSequence(@NonNegative int beginIndex, @NonNegative int endIndex) {
     ...
     */
    public static String valueOf(char data[], @NonNegative int offset, @NonNegative int count) {
     ...
     */
    public static String copyValueOf(char data[], @NonNegative int offset, @NonNegative int count) {
