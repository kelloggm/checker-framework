...
\url{https://checkerframework.org/eclipse/}.)
...
\item
  ...
  \\
  %END LATEX
  \url{https://checkerframework.org/checker-framework-2.1.8.zip}
...
% \item \<docs/manual/> A local copy of this manual in PDF and HTML formats.
...
\item \<-Awarns>
  ...
  \<javac> prints at most 100 warnings.  Don't supply \code{-Werror},
...
\item
 ...
 Section~\ref{creating-debugging-options-misc}.
...
method bodies if the checker is unable to infer the correct annotation.
% or if
